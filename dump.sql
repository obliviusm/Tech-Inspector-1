...
--
-- Host: localhost
-- Generation Time: Apr 19, 2012 at 09:20 PM
...
CREATE TABLE IF NOT EXISTS `locations` (
  ...
  `prophylaxis_date` varchar(20) DEFAULT NULL,
...
INSERT INTO `locations` (`location_id`, `location_name`, `responsible_admin`, `prophylaxis_date`) VALUES
(1, '430', 'Иванов', ''),
(2, '433', 'Петров', ''),
(3, '429/1', 'Сидоров', ''),
(4, '429/2', 'Ололоев', ''),
