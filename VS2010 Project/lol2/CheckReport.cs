    ...
    public partial class CheckReport : Form
    {
        ...
        private List<IElement> SaveTempPDF()
        {
            try
            {
                ...
                BaseFont baseFont = BaseFont.CreateFont(Path.GetFullPath(Properties.Settings.Default.FontsFolder + "/ARIAL.TTF"), BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
                ...
                Image logo = Image.GetInstance(Path.GetFullPath(Properties.Settings.Default.DataFolder + "/images/seal.gif"));
        ...
        private void instructionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                Help.ShowHelp(this, Path.GetFullPath(Properties.Settings.Default.HelpPath));
            }
            catch (Exception err)
            {
                MessageBox.Show("Виникла помилка\n" + err.Message, "Помилка",
